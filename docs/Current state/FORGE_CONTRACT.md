...
emit the same line format. **ADR-094/098/102/103/106/108/109/110/111/112/113/114/115/116/117/118/119:** seed.ae SPEAKs
...
forge **and** verify failure. ADR-110/111/116/117/118/119 add only canonical
ordinary-Whole direct-bind, root-yield-call, root-revise-call, root-speak-call,
and delimiter-bounded root-handle-call target-existence checks against canonical
top-level declaration headers (ordinary, export, host, foreign, or task),
including forward ordinary headers, exact end-of-line zero-argument targets, and
the fixed `into` / `otherwise error into` handle delimiters; this is not general
name binding, destination or terminality validation, Text-result validation, M4
effect validation, or call-kind approval. Full seed SPEAK matrix remains residual
