...
forge **and** verify failure. ADR-110/111/116/117/118/119/120/121/122/123/124/125 add only canonical
...
positive two-digit Whole, exact-`bright` Truth, and exact-`dim` Truth spawn-call target-existence checks against canonical top-level declaration
...
exactly two ASCII decimal digits with a nonzero first digit, exact `bright`, or
exact `dim` before the literal ` into ` delimiter; it is not general name binding,
