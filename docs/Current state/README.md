...
| BARP / seed authority reduction | [BARP design](DESIGN-BARP-001-BOOTSTRAP-AUTHORITY-REDUCTION.md), [BARP validation matrix](BARP-VALIDATION-MATRIX.md), [SBP-001 bundle matrix](SBP-VALIDATION-MATRIX.md), [SBP threat model](THREAT_MODEL-SBP-001-SEED-BUNDLE.md) |
