...
**Date:** 2026-08-11
**Decision records:** [ADR-037](../historical%20docs/ADR-037-f-native-law-fork.md), [HUMAN-AUTHORIZE-NATIVE.md](HUMAN-AUTHORIZE-NATIVE.md), [ADR-059](../historical%20docs/ADR-059-f-native-authorized-m35a-aeth-to-c.md)–[ADR-099](../historical%20docs/ADR-099-m35j-native-cross-compile-target-matrix.md)
