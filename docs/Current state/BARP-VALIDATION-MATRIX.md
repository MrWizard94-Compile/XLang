...
| BARP-SPEAK-096 | Spawn-shaped Text literal, erroring-Whole parent nursery, intervening blank/non-spawn line, six-space descendant, or three-or-more-digit/negative/name/unary-general-Truth/multi-argument child | Do not trigger the literal total-root immediate four-space zero-argument, single-digit, positive-two-digit-Whole, exact-`bright`-Truth, or exact-`dim`-Truth-child pilots; full M7 diagnostics retain authority |
