...
| BARP-SPEAK-096 | Spawn-shaped Text literal, erroring-Whole parent nursery, intervening blank/non-spawn line, six-space descendant, or multi-digit/negative/Truth/multi-argument child | Do not trigger the literal total-root immediate four-space zero-argument or single-digit-Whole-child pilots; full M7 diagnostics retain authority |
...
| BARP-SPEAK-102 | Immediate root nursery multi-digit, negative, Truth, multi-argument, or missing-destination source; delayed/descendant child; or an erroring-Whole parent | Does not trigger the one-digit bounded unknown-target pilot; full M7 syntax/semantic diagnostics retain authority |
