...
| BARP-SPEAK-096 | Spawn-shaped Text literal, erroring-Whole parent nursery, intervening blank/non-spawn line, six-space descendant, or argument-bearing child | Do not trigger the literal total-root immediate four-space zero-argument-child pilot; full M7 diagnostics retain authority |
