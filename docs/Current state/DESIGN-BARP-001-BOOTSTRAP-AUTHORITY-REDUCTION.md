...
**Status:** Active program — product-default toolchain (ADR-064–072; bounded pilot increments through ADR-117); residual recovery bootstrap
**Date:** 2026-08-14 (Phase 1–2 / ADR-044–072; bounded seed-SPEAK pilots through ADR-117; ADR-117 release verified)
**Decision:** [ADR-043](../historical%20docs/ADR-043-bootstrap-authority-reduction.md)–[ADR-117](../historical%20docs/ADR-117-barp-seed-speak-revise-unknown-call-pilot.md)
...
| Seed-error packets | **Host packet ABI** `aether.seed-error/v1` (ADR-072); seed SPEAK pilot 003/004/005/006/007/010/011/012/013/014/015, with bounded lexical 003/007, line-aware canonical reserved-task 014, exact task-checkpoint 015, canonical ordinary-Whole Text-literal / exact Truth-literal yield 010, canonical ordinary-Whole direct bind/root-yield/root-revise target existence across declared top-level weave headers for argument-bearing and exact end-of-line zero-argument calls 011, and canonical ordinary-Whole `choose same` / `choose less` / exact `choose bright:` / exact `choose dim:` / exact `choose not bright:` / exact `choose not dim:` nested-yield 013 detection (ADR-094/098/102/103/106/108/109/110/111/112/113/114/115/116/117); full matrix residual |
