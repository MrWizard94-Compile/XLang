...
**Status:** Active program — product-default toolchain (ADR-064–072; bounded pilot increments through ADR-124); ADR-124 release verified; residual recovery bootstrap
**Date:** 2026-08-14 (Phase 1–2 / ADR-044–072; bounded seed-SPEAK pilots through ADR-124 release verification)
**Decision:** [ADR-043](../historical%20docs/ADR-043-bootstrap-authority-reduction.md)–[ADR-124](../historical%20docs/ADR-124-barp-seed-speak-root-nursery-bright-truth-spawn-unknown-call-pilot.md)
