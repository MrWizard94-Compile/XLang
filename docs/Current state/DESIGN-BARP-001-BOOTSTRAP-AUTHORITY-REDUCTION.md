...
**Status:** Active program — product-default toolchain (ADR-064–072; bounded pilot increments through ADR-121); ADR-121 release verified; residual recovery bootstrap
**Date:** 2026-08-14 (Phase 1–2 / ADR-044–072; bounded seed-SPEAK pilots through ADR-121; ADR-121 release verified)
**Decision:** [ADR-043](../historical%20docs/ADR-043-bootstrap-authority-reduction.md)–[ADR-121](../historical%20docs/ADR-121-barp-seed-speak-root-nursery-zero-argument-spawn-unknown-call-pilot.md)
