...
**Status:** Active program — product-default toolchain (ADR-064–072; bounded pilot increments through ADR-118); residual recovery bootstrap
**Date:** 2026-08-14 (Phase 1–2 / ADR-044–072; bounded seed-SPEAK pilots through ADR-118; ADR-118 release verified)
**Decision:** [ADR-043](../historical%20docs/ADR-043-bootstrap-authority-reduction.md)–[ADR-118](../historical%20docs/ADR-118-barp-seed-speak-root-speak-unknown-call-pilot.md)
