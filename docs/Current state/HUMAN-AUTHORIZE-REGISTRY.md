...
**Law:** [ADR-038](../historical%20docs/ADR-038-f-registry-law-fork.md), [ADR-060](../historical%20docs/ADR-060-f-registry-authorized-m24a-offline-cache.md), [DESIGN-LAW-FORK-F-REGISTRY.md](DESIGN-LAW-FORK-F-REGISTRY.md), [THREAT_MODEL-v5-PACKAGE-REGISTRY.md](THREAT_MODEL-v5-PACKAGE-REGISTRY.md)
...
**Reaffirmed (2026-08-11):** human again wrote `I authorize Aether law fork F-REGISTRY`
when directing M24b–g work (ADR-074–092), including multi-level cert chains.
