...
specified in [AETHER_0.36.md](../historical%20docs/AETHER_0.36.md),
[DESIGN-M19E-T-RX-ACTIVE-FRAME-CANCEL.md](../historical%20docs/DESIGN-M19E-T-RX-ACTIVE-FRAME-CANCEL.md),
and [ADR-042](../historical%20docs/ADR-042-m19e-active-frame-cancel.md). The PKG-001 workspace-integrity
increment is specified historically in [AETHER_0.35.md](../historical%20docs/AETHER_0.35.md) and
[ADR-041](../historical%20docs/ADR-041-pkg-001-offline-workspace-locks.md). RTP-001 remains
specified in [AETHER_0.34.md](../historical%20docs/AETHER_0.34.md) and
[ADR-040](../historical%20docs/ADR-040-runtime-text-ascii-fast-path.md); the M23 language addition
remains specified in [AETHER_0.33.md](../historical%20docs/AETHER_0.33.md) and
[ADR-039](../historical%20docs/ADR-039-m23-comptime-pure-calls.md). The broader AI-first
...
[DESIGN-M25-LOCAL-PACKAGE-PUBLICATION.md](../historical%20docs/DESIGN-M25-LOCAL-PACKAGE-PUBLICATION.md),
and [ADR-107](../historical%20docs/ADR-107-m25-local-package-publication.md). It is a host CLI
filesystem protocol only; it has no source, AETH, seed, VM, or guest-authority
effect.

ADR-128/129 add separate, bounded seed-native source-bundle routes. A caller
may supply a v1 `aether.seed-bundle/v1` library -> entry file or a v2
`aether.seed-bundle/v2` foundation -> bridge -> entry file to default `compile`
or explicit `forge-bundle`. The host carries opaque Text to the verified seed
`compile_bundle` weave; the seed alone validates the fixed frame, imports,
names, and source profile before producing one compiled source. The route does
not invoke host M11/M22 elaboration and grants no file, resolver, network, or
callback authority to seed code. These are fixed profiles, not a general
seed-native module graph. See [ADR-129](../historical%20docs/ADR-129-barp-seed-native-transitive-library-chain-profile.md)
...
versioned structural authoring v8, and the ADR-128/129 bounded source-bundle
profiles. M23 adds
...
[AETHER_0.33.md](../historical%20docs/AETHER_0.33.md).
...
or broad speed claim; see [ADR-104](../historical%20docs/ADR-104-m32a-verified-execution-benchmarks.md)
and [ADR-105](../historical%20docs/ADR-105-m32b-profile-bound-comparisons.md).
