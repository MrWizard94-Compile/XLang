...
| SBP-005 | Ordinary raw `import unit` source remains `AE-SEED-012`; a v1 JSON envelope is host-framed into GSM-001 opaque catalog Text and seed-elaborated. | Existing product diagnostics and v1 envelope regressions remain green. |
...
| SBP-015 | v2 remains a fixed three-unit profile and is exercised by product, named-forge, release, and isolated consumer paths alongside GSM-001. | Fixed-profile tracker, route tracker, `aether-gate`, and preview-verifier coverage. |
...
| SBP-020 | v3 remains a fixed four-unit fan-in profile and is covered by product, named-forge, release, and isolated consumer paths alongside GSM-001. | Fixed-profile tracker, route tracker, `aether-gate`, and preview-verifier coverage. |
