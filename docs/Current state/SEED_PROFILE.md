...
oracle, and residual nested body-list structural AST only. **ADR-094/098/102/103/106/108/109/110/111/112/113/114/115/116/117/118:** seed
...
exact `choose not dim:` nested yield, and canonical direct bind/root-yield/root-revise/root-speak
...
diagnostic-parity claim. ADR-110/111/116/117/118 separately recognize canonical
ordinary-Whole `bind … <- call target`, root `yield call target`, or root
`revise name <- call target` or root `speak call target` statements whose `target` has no canonical
