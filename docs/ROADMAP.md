...
The current design proposal for this milestone is captured in [DESIGN-M6-SHAPE-LAYOUT-EXPERIMENT.md](DESIGN-M6-SHAPE-LAYOUT-EXPERIMENT.md). It intentionally stays bounded and does not claim implementation until the acceptance gate is met.
