...
The current design proposal for this milestone is captured in [DESIGN-M6-SHAPE-LAYOUT-EXPERIMENT.md](DESIGN-M6-SHAPE-LAYOUT-EXPERIMENT.md), and the validation checklist is recorded in [M6-VALIDATION-MATRIX.md](M6-VALIDATION-MATRIX.md). They intentionally stay bounded and do not claim implementation until the acceptance gate is met.
