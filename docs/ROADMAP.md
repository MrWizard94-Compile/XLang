...
**Date:** 2026-08-14 (BARP through ADR-113; product authority reduction active)
...
reduce Rust bootstrap product-path authority. **Through ADR-113:** seed SPEAK
...
detection plus canonical ordinary-Whole `choose same` / `choose less` /
exact `choose bright:` / exact `choose dim:` nested-yield detection,
