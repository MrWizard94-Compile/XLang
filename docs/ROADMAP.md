...
**Date:** 2026-08-10 (BARP through ADR-052; product authority reduction active)
...
reduce Rust bootstrap product-path authority. **Through ADR-052:** seed-native
M23, bootstrap-free `compile_with_seed`, product CLI `check --product`, product
lib project-verify, Phase 3a–3c `AE-SEED-001`–`011` product codes, multi-module/edit
product gates, gate product seed self-rebuild.
