...
## Seed SPEAK diagnostic contract (ADR-082/086/090/094/098/102/103/106/108)
...
emit the same line format. **ADR-094/098/102/103/106/108/109/110:** seed.ae SPEAKs
...
canonical ordinary-Whole body scan for an indented `yield "..."` line. ADR-109
adds only a canonical ordinary-Whole `choose same` nested-yield witness for
013; the product preflight retains broader 013 coverage. Host merges SPEAK on
