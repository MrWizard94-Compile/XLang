...
- ADR-094, ADR-098, [BARP validation matrix](BARP-VALIDATION-MATRIX.md),
  [Seed Profile](SEED_PROFILE.md), [BARP design](DESIGN-BARP-001-BOOTSTRAP-AUTHORITY-REDUCTION.md)
