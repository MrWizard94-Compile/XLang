...
**Date:** 2026-08-04 (Aether 0.11 M8 update)
...
| CLM-017 | Offline ether.project/v1 documents with optional SHA-256 locks and CLI format/project verify provide local project integrity without a network registry or LSP. | **Proven now, bounded M9 scope** | [AETHER_0.12.md](AETHER_0.12.md), [M9 design](DESIGN-M9-PROJECT-TOOLING.md), [ADR-012](ADR-012-m9-project-tooling.md), project module tests, xamples/project. | Require a new ADR before multi-package graphs, registries, or full LSP. |
