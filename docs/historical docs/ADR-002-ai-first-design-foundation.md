...
* Related design: [NORTH_STAR.md](../Current%20state/NORTH_STAR.md), [CORE_CLAIMS.md](../Current%20state/CORE_CLAIMS.md), [ROADMAP.md](../Current%20state/ROADMAP.md).
...
* Related product contract: [MANIFEST.md](../../MANIFEST.md), [ARCHITECTURE.md](../Current%20state/ARCHITECTURE.md).
