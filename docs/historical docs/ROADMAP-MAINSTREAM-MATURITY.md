...
[MANIFEST.md](../../MANIFEST.md), [ROADMAP.md](../Current%20state/ROADMAP.md),
[AETHER_0.37.md](../Current%20state/AETHER_0.37.md), and
[PROGRESS_REPORT-FULL-PROJECT.md](../Current%20state/PROGRESS_REPORT-FULL-PROJECT.md)
...
**Claims law:** [CORE_CLAIMS.md](../Current%20state/CORE_CLAIMS.md) — **CLM-011 prohibits** “better than all languages”
**North star:** [NORTH_STAR.md](../Current%20state/NORTH_STAR.md) (direction ≠ current behavior)
...
| --- | --- | --- | --- |
| **F-NATIVE** | Optional **verified AETH → native**; VM default/reference; no source transpile | Stay AETH-VM; optional future JIT under separate ADR | [ADR-037](ADR-037-f-native-law-fork.md), [HUMAN-AUTHORIZE-NATIVE.md](../Current%20state/HUMAN-AUTHORIZE-NATIVE.md) |
| **F-REGISTRY** | Signed offline-first registry; explicit host fetch; guest still offline | Path/workspace packages only (M18/M22) | [ADR-038](ADR-038-f-registry-law-fork.md), [HUMAN-AUTHORIZE-REGISTRY.md](../Current%20state/HUMAN-AUTHORIZE-REGISTRY.md) |
