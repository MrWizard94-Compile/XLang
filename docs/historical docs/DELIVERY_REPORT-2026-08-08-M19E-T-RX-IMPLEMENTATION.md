...
**Acceptance record:** [M19e validation matrix](../Current%20state/M19E-VALIDATION-MATRIX.md)
...
5. **Authoring and public contract**
   ...
   - Added v8 AST/edit/diagnostic schemas and
     [AETHER_AUTHORING_PROTOCOL_v8.md](../Current%20state/AETHER_AUTHORING_PROTOCOL_v8.md).
...
[completed M19e matrix](../Current%20state/M19E-VALIDATION-MATRIX.md).
