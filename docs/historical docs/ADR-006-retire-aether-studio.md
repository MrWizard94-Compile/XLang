...
* Related product contract: [MANIFEST.md](../../MANIFEST.md), [ARCHITECTURE.md](../Current%20state/ARCHITECTURE.md), [AETHER_AUTHORING_PROTOCOL_v2.md](AETHER_AUTHORING_PROTOCOL_v2.md).
