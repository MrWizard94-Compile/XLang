...
**Validation gate:** [M19e validation matrix](../Current%20state/M19E-VALIDATION-MATRIX.md)
...
6. Deliver the entire [M19e validation matrix](../Current%20state/M19E-VALIDATION-MATRIX.md), full
