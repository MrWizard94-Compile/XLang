...
**Validation:** [M19e validation matrix](../Current%20state/M19E-VALIDATION-MATRIX.md)
...
[AETHER_AUTHORING_PROTOCOL_v8.md](../Current%20state/AETHER_AUTHORING_PROTOCOL_v8.md) and the
