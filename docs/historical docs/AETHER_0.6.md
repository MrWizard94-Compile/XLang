...
- [SEED_PROFILE.md](../Current%20state/SEED_PROFILE.md) — normative product compiler proof scope.
- [FORGE_CONTRACT.md](../Current%20state/FORGE_CONTRACT.md) — host ABI and verify-before-write law.
