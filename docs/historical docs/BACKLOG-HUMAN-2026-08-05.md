...
| **3** | Ownership + destroy + mid-frame cancel | **Implemented in package 0.36**: [M19e](DESIGN-M19E-T-RX-ACTIVE-FRAME-CANCEL.md) / [ADR-042](ADR-042-m19e-active-frame-cancel.md) / [matrix](../Current%20state/M19E-VALIDATION-MATRIX.md); bounded v12 task/checkpoint scope only |
...
- [HUMAN-AUTHORIZE-NATIVE.md](../Current%20state/HUMAN-AUTHORIZE-NATIVE.md) and/or
- [HUMAN-AUTHORIZE-REGISTRY.md](../Current%20state/HUMAN-AUTHORIZE-REGISTRY.md)
