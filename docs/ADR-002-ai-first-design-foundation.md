...
and structural AI editing. The executable product has a smaller, strong Aether
0.5 boundary: seed-hosted compilation, verified AETH v4/v5 artifacts, a
capability-free VM, and bounded value semantics.
