...
`format --product` LF-normalizes and product-accepts without bootstrap AST rewrite
(default `format` remains full bootstrap canonical; ADR-053). Project verify
validates lib units via product seed probes (ADR-052).
