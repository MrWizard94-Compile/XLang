...
**Status:** Active program — product-default toolchain (ADR-064–072; bounded pilot increments through ADR-113); residual recovery bootstrap
**Date:** 2026-08-14 (Phase 1–2 / ADR-044–072; bounded seed-SPEAK pilots through ADR-113)
**Decision:** [ADR-043](ADR-043-bootstrap-authority-reduction.md)–[ADR-113](ADR-113-barp-seed-speak-literal-truth-choose-yield-pilot.md)
...
| Seed-error packets | **Host packet ABI** `aether.seed-error/v1` (ADR-072); seed SPEAK pilot 003/004/005/006/007/010/011/012/013/014/015, with bounded lexical 003/007, line-aware canonical reserved-task 014, exact task-checkpoint 015, canonical ordinary-Whole Text-literal-yield 010, canonical ordinary-Whole direct bind/root-yield call target existence across declared top-level weave headers 011, and canonical ordinary-Whole `choose same` / `choose less` / exact `choose bright:` / exact `choose dim:` nested-yield 013 detection (ADR-094/098/102/103/106/108/109/110/111/112/113); full matrix residual |
| Yield-in-truth-choose | **Product fail-closed** `AE-SEED-013` (ADR-070); direct seed has only the ADR-109/112/113 canonical `choose same` / `choose less` / exact literal Truth witnesses; multi-module choose+revise supported |
