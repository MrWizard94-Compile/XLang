...
**Status:** Active program — product-default toolchain (ADR-064–072; bounded pilot increments through ADR-114); residual recovery bootstrap
**Date:** 2026-08-14 (Phase 1–2 / ADR-044–072; bounded seed-SPEAK pilots through ADR-114)
**Decision:** [ADR-043](ADR-043-bootstrap-authority-reduction.md)–[ADR-114](ADR-114-barp-seed-speak-unary-literal-truth-choose-yield-pilot.md)
