...
**Status:** Active program — product-default toolchain (ADR-064–072; bounded pilot increments through ADR-102); residual recovery bootstrap
**Date:** 2026-08-11 (Phase 1–2 / ADR-044–072; bounded seed-SPEAK pilots through ADR-102)
**Decision:** [ADR-043](ADR-043-bootstrap-authority-reduction.md)–[ADR-102](ADR-102-barp-seed-speak-lexical-edge-pilot.md)
...
| Seed-error packets | **Host packet ABI** `aether.seed-error/v1` (ADR-072); seed SPEAK pilot 003/004/005/006/007/012, with bounded lexical 003/007 detection (ADR-094/098/102); full matrix residual |
