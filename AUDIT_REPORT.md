...
Date: 2026-07-28 (Stage 6 immutable-record parity update)
...
The production bootstrap compiler accepts Aether 0.5.0 source. It produces a
canonical AST and deterministic AETH v4 or v5 bytecode artifact, verifies that
artifact, and runs it in the Aether VM. The command line and desktop app call
the same compiler core.

Stage 6 completes canonical Aether 0.5 source-emission parity in the
...
canonical Aether 0.5 surface and emits v4 or v5 through ordinary language
...
This is canonical Aether 0.5 source-emission self-hosting. Rust remains the
