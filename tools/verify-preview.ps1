...
function Resolve-PackageRoot {
    ...
    foreach ($name in @("aether-0.17.0-tp", "aether-0.16.0-tp", "aether-0.15.0-tp", "aether-0.14.0-tp", "aether-0.13.0-tp", "aether-0.12.0-tp")) {
...
if ($verOut -notmatch "0\.17\.0") { Fail "expected version 0.17.0 in: $verOut" }
