...
| M32a verified-execution benchmark suite | [docs/ADR-104-m32a-verified-execution-benchmarks.md](docs/ADR-104-m32a-verified-execution-benchmarks.md), [docs/DESIGN-M32A-VERIFIED-EXECUTION-BENCHMARKS.md](docs/DESIGN-M32A-VERIFIED-EXECUTION-BENCHMARKS.md), [docs/M32A-VALIDATION-MATRIX.md](docs/M32A-VALIDATION-MATRIX.md) — closed `aether bench` corpus; post-0.36, no language/AETH/capability expansion |
