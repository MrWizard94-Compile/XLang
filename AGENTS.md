...
| Core crate | `aether-core` at `crates/xlang-core` (package version 0.22.0) |
| CLI binary | `aether` via `apps/xlang-cli` (package `aether-cli` 0.22.0) |
