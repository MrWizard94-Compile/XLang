...
| BARP bootstrap authority reduction | [docs/ADR-043-bootstrap-authority-reduction.md](docs/ADR-043-bootstrap-authority-reduction.md)–[docs/ADR-047-barp-product-emit-no-bootstrap-ast.md](docs/ADR-047-barp-product-emit-no-bootstrap-ast.md), [docs/DESIGN-BARP-001-BOOTSTRAP-AUTHORITY-REDUCTION.md](docs/DESIGN-BARP-001-BOOTSTRAP-AUTHORITY-REDUCTION.md) — through ADR-047 |
...
| Product compile | Seed forge-first; multi-module without bootstrap AST (ADR-047); `AE-SEED-*` Phase 3a; dual-compare in tests/gate; M19e v12 |
