...
| BARP bootstrap authority reduction | [docs/ADR-043-bootstrap-authority-reduction.md](docs/historical%20docs/ADR-043-bootstrap-authority-reduction.md)–[docs/ADR-118-barp-seed-speak-root-speak-unknown-call-pilot.md](docs/historical%20docs/ADR-118-barp-seed-speak-root-speak-unknown-call-pilot.md), [docs/DESIGN-BARP-001-BOOTSTRAP-AUTHORITY-REDUCTION.md](docs/Current%20state/DESIGN-BARP-001-BOOTSTRAP-AUTHORITY-REDUCTION.md), [docs/BARP-VALIDATION-MATRIX.md](docs/Current%20state/BARP-VALIDATION-MATRIX.md), [docs/DELIVERY_REPORT-2026-08-14-BARP-ROOT-SPEAK-UNKNOWN-CALL-SPEAK.md](docs/historical%20docs/DELIVERY_REPORT-2026-08-14-BARP-ROOT-SPEAK-UNKNOWN-CALL-SPEAK.md) — product-default toolchain; residual seed SPEAK full matrix / seed-native multi-file |
