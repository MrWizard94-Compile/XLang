...
| BARP bootstrap authority reduction | [docs/ADR-043-bootstrap-authority-reduction.md](docs/historical%20docs/ADR-043-bootstrap-authority-reduction.md)–[docs/ADR-128-barp-seed-native-whole-library-bundle-profile.md](docs/historical%20docs/ADR-128-barp-seed-native-whole-library-bundle-profile.md), [docs/DESIGN-BARP-001-BOOTSTRAP-AUTHORITY-REDUCTION.md](docs/Current%20state/DESIGN-BARP-001-BOOTSTRAP-AUTHORITY-REDUCTION.md), [docs/BARP-VALIDATION-MATRIX.md](docs/Current%20state/BARP-VALIDATION-MATRIX.md), [docs/SBP-VALIDATION-MATRIX.md](docs/Current%20state/SBP-VALIDATION-MATRIX.md), [docs/THREAT_MODEL-SBP-001-SEED-BUNDLE.md](docs/Current%20state/THREAT_MODEL-SBP-001-SEED-BUNDLE.md), [docs/DELIVERY_REPORT-2026-08-21-BARP-SEED-NATIVE-WHOLE-LIBRARY-BUNDLE-PROFILE.md](docs/historical%20docs/DELIVERY_REPORT-2026-08-21-BARP-SEED-NATIVE-WHOLE-LIBRARY-BUNDLE-PROFILE.md) — product-default toolchain; ADR-128 release verified; residual seed SPEAK full matrix / general seed-native multi-file |
...
| Product compile | Seed forge-first (ADR-049); multi-module/edit product gates; bounded ADR-128 seed-native two-unit bundle profile; `AE-SEED-001`–`007` preflights (ADR-050); dual-compare tests/gate; M19e v12 |
...
4. **Honest self-host claims** — dual-compare only where proven (including M19e/M23/SBP corpora as documented); M23 is seed-native only under its D2a body subset and SBP-001 only under its exact two-unit pure Whole profile; do not claim full diagnostic parity or general seed-native M11/M22.
