...
| BARP bootstrap authority reduction | [docs/ADR-043-bootstrap-authority-reduction.md](docs/ADR-043-bootstrap-authority-reduction.md)–[docs/ADR-115-barp-seed-speak-whole-truth-yield-pilot.md](docs/ADR-115-barp-seed-speak-whole-truth-yield-pilot.md), [docs/DESIGN-BARP-001-BOOTSTRAP-AUTHORITY-REDUCTION.md](docs/DESIGN-BARP-001-BOOTSTRAP-AUTHORITY-REDUCTION.md), [docs/BARP-VALIDATION-MATRIX.md](docs/BARP-VALIDATION-MATRIX.md), [docs/DELIVERY_REPORT-2026-08-14-BARP-WHOLE-TRUTH-YIELD-SPEAK.md](docs/DELIVERY_REPORT-2026-08-14-BARP-WHOLE-TRUTH-YIELD-SPEAK.md) — product-default toolchain; residual seed SPEAK full matrix / seed-native multi-file |
