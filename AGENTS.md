...
proof dual-compare. Seed Profile self-host, all shipped seed-path examples,
...
spawn-arena corpus, and the M21 foreign-pilot corpus match bootstrap
...
| M19–M22 portfolio continuation | [docs/AETHER_0.32.md](docs/AETHER_0.32.md) (current); M19 [ADR-023](docs/ADR-023-m19-deeper-resource-effect.md); M19a [docs/AETHER_0.25.md](docs/AETHER_0.25.md) / [ADR-027](docs/ADR-027-m19a-explicit-release.md); M19b [docs/AETHER_0.26.md](docs/AETHER_0.26.md) / [ADR-028](docs/ADR-028-m19b-nursery-resource.md); M19c cooperative Policy B [ADR-036](docs/ADR-036-m19c-policy-b-cooperative.md) (historical design ADR-032); M19d multi-weave arenas [ADR-035](docs/ADR-035-m19d-spawn-scoped-arena.md) (direction ADR-034); M20 [ADR-024](docs/ADR-024-m20-stdlib-layer0.md); M20b [docs/AETHER_0.27.md](docs/AETHER_0.27.md) / [ADR-029](docs/ADR-029-m20b-stdlib-layer1.md); M17b–d [docs/AETHER_0.28.md](docs/AETHER_0.28.md)–[0.30](docs/AETHER_0.30.md); M21 foreign pilot [docs/AETHER_0.31.md](docs/AETHER_0.31.md) / [ADR-025](docs/ADR-025-m21-foreign-abi-pilot.md); M22 [ADR-026](docs/ADR-026-m22-cross-package-import.md); full status [docs/PROGRESS_REPORT-FULL-PROJECT.md](docs/PROGRESS_REPORT-FULL-PROJECT.md) |
...
| Core crate | `aether-core` at `crates/xlang-core` (package version 0.32.0) |
| CLI binary | `aether` via `apps/xlang-cli` (package `aether-cli` 0.32.0) |
| Artifact format | AETH **v4–v10** compatibility input + deterministic **v11** output with shape table, dual-layout tables, structured nurseries, effect metadata, host function kind, `HOST_CALL`, `COMPTIME_WHOLE`, and `RELEASE` (66; M19a/M19b/M19d seed≡bootstrap proven) (earlier/unknown versions rejected) |
| Product compile | Seed-hosted for the documented seed surface, including M21 foreign weave pilot and M19d multi-weave arenas |
