...
| BARP bootstrap authority reduction | [docs/ADR-043-bootstrap-authority-reduction.md](docs/historical%20docs/ADR-043-bootstrap-authority-reduction.md)–[docs/ADR-129-barp-seed-native-transitive-library-chain-profile.md](docs/historical%20docs/ADR-129-barp-seed-native-transitive-library-chain-profile.md), [docs/DESIGN-BARP-001-BOOTSTRAP-AUTHORITY-REDUCTION.md](docs/Current%20state/DESIGN-BARP-001-BOOTSTRAP-AUTHORITY-REDUCTION.md), [docs/BARP-VALIDATION-MATRIX.md](docs/Current%20state/BARP-VALIDATION-MATRIX.md), [docs/SBP-VALIDATION-MATRIX.md](docs/Current%20state/SBP-VALIDATION-MATRIX.md), [docs/THREAT_MODEL-SBP-001-SEED-BUNDLE.md](docs/Current%20state/THREAT_MODEL-SBP-001-SEED-BUNDLE.md), [docs/THREAT_MODEL-SBP-002-SEED-CHAIN.md](docs/Current%20state/THREAT_MODEL-SBP-002-SEED-CHAIN.md), [docs/DELIVERY_REPORT-2026-08-21-BARP-SEED-NATIVE-TRANSITIVE-LIBRARY-CHAIN-PROFILE.md](docs/historical%20docs/DELIVERY_REPORT-2026-08-21-BARP-SEED-NATIVE-TRANSITIVE-LIBRARY-CHAIN-PROFILE.md) — product-default toolchain; ADR-128/129 release verified; residual seed SPEAK full matrix / general seed-native multi-file |
...
| Product compile | Seed forge-first (ADR-049); multi-module/edit product gates; bounded ADR-128 v1 two-unit and ADR-129 v2 transitive-three-unit seed-native bundle profiles; `AE-SEED-001`–`007` preflights (ADR-050); dual-compare tests/gate; M19e v12 |
