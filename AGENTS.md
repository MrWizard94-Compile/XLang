...
| BARP bootstrap authority reduction | [docs/ADR-043-bootstrap-authority-reduction.md](docs/historical%20docs/ADR-043-bootstrap-authority-reduction.md)–[docs/ADR-119-barp-seed-speak-root-handle-unknown-call-pilot.md](docs/historical%20docs/ADR-119-barp-seed-speak-root-handle-unknown-call-pilot.md), [docs/DESIGN-BARP-001-BOOTSTRAP-AUTHORITY-REDUCTION.md](docs/Current%20state/DESIGN-BARP-001-BOOTSTRAP-AUTHORITY-REDUCTION.md), [docs/BARP-VALIDATION-MATRIX.md](docs/Current%20state/BARP-VALIDATION-MATRIX.md), [docs/DELIVERY_REPORT-2026-08-14-BARP-ROOT-HANDLE-UNKNOWN-CALL-SPEAK.md](docs/historical%20docs/DELIVERY_REPORT-2026-08-14-BARP-ROOT-HANDLE-UNKNOWN-CALL-SPEAK.md) — product-default toolchain; ADR-119 release verified; residual seed SPEAK full matrix / seed-native multi-file |
