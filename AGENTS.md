...
and M6 (explicit layout shapes and dual-layout tables) are implemented on the
seed-hosted product compile path in Aether 0.9 / AETH v9.
...
corpus, the M4 error-effect corpus, the M5 comptime corpus, and the M6 layout
corpus match bootstrap byte-for-byte.
...
| Language (0.9 current / 0.8–0.4 historical) | [docs/AETHER_0.9.md](docs/AETHER_0.9.md), [docs/AETHER_0.8.md](docs/AETHER_0.8.md), [docs/AETHER_0.7.md](docs/AETHER_0.7.md), [docs/AETHER_0.6.md](docs/AETHER_0.6.md), [docs/AETHER_0.5.md](docs/AETHER_0.5.md), [docs/AETHER_0.4.md](docs/AETHER_0.4.md) |
...
| M3–M6 authoring, effects, comptime, layout | [docs/AETHER_AUTHORING_PROTOCOL_v4.md](docs/AETHER_AUTHORING_PROTOCOL_v4.md), [docs/ADR-007-m4-typed-error-effect.md](docs/ADR-007-m4-typed-error-effect.md), [docs/ADR-008-m5-deterministic-comptime.md](docs/ADR-008-m5-deterministic-comptime.md), [docs/ADR-009-m6-explicit-layout-shapes.md](docs/ADR-009-m6-explicit-layout-shapes.md), [docs/M4-VALIDATION-MATRIX.md](docs/M4-VALIDATION-MATRIX.md), [docs/M5-VALIDATION-MATRIX.md](docs/M5-VALIDATION-MATRIX.md), [docs/M6-VALIDATION-MATRIX.md](docs/M6-VALIDATION-MATRIX.md) |
...
| Core crate | `aether-core` at `crates/xlang-core` (package version 0.9.0) |
| CLI binary | `aether` via `apps/xlang-cli` (package `aether-cli` 0.9.0) |
| Artifact format | AETH **v4/v5/v6/v7/v8** compatibility input + deterministic **v9** output with shape table, dual-layout tables, effect metadata, and `COMPTIME_WHOLE` provenance (earlier/unknown versions rejected) |
...
4. **Honest self-host claims** — Seed Profile, shipped examples, the complete documented prior canonical surface (including immutable records), and the documented M2 arena/buffer, M4 error-effect, M5 comptime, and M6 layout corpora match bootstrap in tests; do not claim full diagnostic parity or parity for future language extensions without proof.
