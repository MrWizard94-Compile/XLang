...
| BARP bootstrap authority reduction | [docs/ADR-043-bootstrap-authority-reduction.md](docs/historical%20docs/ADR-043-bootstrap-authority-reduction.md)–[docs/ADR-130-barp-seed-native-fanin-bundle-profile.md](docs/historical%20docs/ADR-130-barp-seed-native-fanin-bundle-profile.md), [docs/DESIGN-BARP-001-BOOTSTRAP-AUTHORITY-REDUCTION.md](docs/Current%20state/DESIGN-BARP-001-BOOTSTRAP-AUTHORITY-REDUCTION.md), [docs/BARP-VALIDATION-MATRIX.md](docs/Current%20state/BARP-VALIDATION-MATRIX.md), [docs/SBP-VALIDATION-MATRIX.md](docs/Current%20state/SBP-VALIDATION-MATRIX.md), [docs/THREAT_MODEL-SBP-001-SEED-BUNDLE.md](docs/Current%20state/THREAT_MODEL-SBP-001-SEED-BUNDLE.md), [docs/THREAT_MODEL-SBP-002-SEED-CHAIN.md](docs/Current%20state/THREAT_MODEL-SBP-002-SEED-CHAIN.md), [docs/THREAT_MODEL-SBP-003-SEED-FANIN.md](docs/Current%20state/THREAT_MODEL-SBP-003-SEED-FANIN.md), [docs/DELIVERY_REPORT-2026-08-26-BARP-SEED-NATIVE-FANIN-BUNDLE-PROFILE.md](docs/historical%20docs/DELIVERY_REPORT-2026-08-26-BARP-SEED-NATIVE-FANIN-BUNDLE-PROFILE.md) — product-default toolchain; ADR-128/129/130 release verified; residual seed SPEAK full matrix / general seed-native multi-file |
...
| Product compile | Seed forge-first (ADR-049); multi-module/edit product gates; bounded ADR-128 v1 two-unit, ADR-129 v2 transitive-three-unit, and ADR-130 v3 four-unit two-leaf fan-in seed-native bundle profiles; `AE-SEED-001`–`007` preflights (ADR-050); dual-compare tests/gate; M19e v12 |
...
4. **Honest self-host claims** — dual-compare only where proven (including M19e/M23/SBP corpora as documented); M23 is seed-native only under its D2a body subset, SBP-001 only under its exact two-unit pure Whole profile, SBP-002 only under its exact foundation -> bridge -> entry profile, and SBP-003 only under its exact left leaf + right leaf -> merge -> entry fan-in profile; do not claim full diagnostic parity or general seed-native M11/M22.
