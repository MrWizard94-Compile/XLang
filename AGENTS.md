...
0.12 added offline project verify and format (M9); package **0.13** adds multi-unit nested project integrity (M10); package **0.18** completes modules (M11), fine-grained edits (M12), and bounded offline LSP M13a+M13b (`aether lsp [--project …]`).
...
| M14 host I/O (designed) | [docs/DESIGN-M14-HOST-IO-CAPABILITIES.md](docs/DESIGN-M14-HOST-IO-CAPABILITIES.md), [docs/ADR-018-m14-host-io-capabilities.md](docs/ADR-018-m14-host-io-capabilities.md), [docs/M14-VALIDATION-MATRIX.md](docs/M14-VALIDATION-MATRIX.md) |
...
| Core crate | `aether-core` at `crates/xlang-core` (package version 0.18.0) |
| CLI binary | `aether` via `apps/xlang-cli` (package `aether-cli` 0.18.0) |
