...
| Path | Role |
|------|------|
| **Seed (default)** | `compile_product_bytecode` / CLI `compile` / project+workspace build / lib project-verify / apply-edit accept / `check --product` — forge-first; multi-module no bootstrap (ADR-047/048/051/052) |
