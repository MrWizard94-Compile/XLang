...
nested-yield witnesses, and exact literal `choose bright:` / `choose dim:`
...
adds only exact `choose bright:` / `choose dim:` witnesses. ADR-070 retains the
broader product preflight.
