...
Aether **0.30.0** (base language **0.11** plus M11–M18, M19a, M19b, M20/M20b,
M17b/M17c/M17d, M22 tooling and semantics, AETH **v11** with `RELEASE` 66)
...
compiler** (forge ABI) for the documented seed surface, including M19a
`release`, M19b nursery×resource Policy A, pure stdlib layer 1, project
`role: test`, optional test grants, and optional structured test reports.
...
provides offline project/workspace verify, `aether test` / `aether project
test` (optional `--grant-*`, `--report`, `--report-junit`), `aether lsp`, and
...
This manifest is the executable Aether 0.30 product contract (0.11 core language,
M9–M18/M19a/M19b/M20/M20b/M17b–M17d/M22 tooling with honest seed limits). It
